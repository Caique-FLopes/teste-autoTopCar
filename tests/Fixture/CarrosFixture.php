...
class CarrosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'year' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'placa' => ['type' => 'string', 'length' => 7, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'carros_ibfk_1' => ['type' => 'foreign', 'columns' => ['marca_id'], 'references' => ['marcas', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'year' => 1,
                'placa' => 'Lorem',
                'created_at' => '2025-10-05 03:52:18',
                'updated_at' => '2025-10-05 03:52:18',
            ],
        ];
        parent::init();
    }
